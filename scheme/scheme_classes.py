...
class Frame:
    ...
    def define(self, symbol, value):# binds the symbol to the value in the Frame instance.
        #让symbol作为key，对应一个value
    ...
    def make_child_frame(self, formals, vals):
        ...
        current_formals, current_vals = formals,vals
        if current_formals is not nil and current_vals is not nil:
            new_frame.define(current_formals.first,current_vals.first)
            return new_frame.make_child_frame(current_formals.rest,current_vals.rest)
        else:
            return new_frame
        # END PROBLEM 8
