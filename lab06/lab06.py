...
class BankAccount():
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(
            Transaction(id=self.id ,before=self.balance,after=self.balance + amount)
        )    
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(
            Transaction(id=self.id ,before=self.balance,after=self.balance)
        )
